...
namespace BLL_ORDENESCOMPRA.GESTOR_BD
{
    public class cls_GESTOR_BD_BLL
    {
        /// <summary>
        ...
        /// <returns></returns>
        public DataTable gestionaParametros(DataTable DT_Param)
        {
        ...
        public void gestionaProcesosTabla(ref cls_GESTOR_BD_DAL Obj_BD_DAL)
        {
            try
            {
        ...
        /// </summary>
        /// <param name="Obj_BD_DAL">RECIBE EL OBJETO DEL TIPO DE LA CLASE BD DEL PROYECTO DAL</param>
        public void gestionaProcesosComando(ref cls_GESTOR_BD_DAL Obj_BD_DAL)
        {
            try
            {
                Obj_BD_DAL.Obj_CNX = new SqlConnection(ConfigurationManager.ConnectionStrings["CNX_SQL"].ToString());
